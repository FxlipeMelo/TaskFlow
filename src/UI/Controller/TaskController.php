...
use App\UI\Form\TaskCreateFormType;
...
final class TaskController extends AbstractController
{
    ...
    {
        $taskList = $this->taskRepository->findTasksWithRelations(['status' => TaskStatus::OPEN->value], ['createdAt' => 'ASC']);
    ...
    {
        $taskList = $this->taskRepository->findTasksWithRelations(['status' => TaskStatus::FINISHED->value], ['createdAt' => 'ASC']);
    ...
    {
        $taskList = $this->taskRepository->findTasksWithRelations(['status' => TaskStatus::DELETED->value], ['createdAt' => 'ASC']);
